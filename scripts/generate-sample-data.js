...
const branchData = [
  ...
  { collegeName: "BMS College of Engineering", branchCode: "ISE", branchName: "Information Science & Engineering", tuitionFeeAnnual: 110000, hostelFeeAnnual: 70000, seatCapacity: 120, avgSalary: 750000, medianSalary: 700000, highestSalary: 2500000, minJeePercentileCutoff: 92.0, minClass12Cutoff: 82.0, branchStrengthScore: 8.2, placementPercentage: 88.0 },
...
const pathways = [
  ...
  { collegeName: "RV College of Engineering", branchCode: "ISE", admissionExam: "COMEDK", equivalentJeePercentile: 94.0, admissionMode: "Counseling" },
  // DY Patil
  ...
  { collegeName: "BMS College of Engineering", branchCode: "ISE", admissionExam: "COMEDK", equivalentJeePercentile: 91.0, admissionMode: "Counseling" },
  // PICT
  ...
  { collegeName: "RV Institute of Technology and Management", branchCode: "ISE", admissionExam: "COMEDK", equivalentJeePercentile: 87.0, admissionMode: "Counseling" },
  // DSCE
...
// Sample datasets
writeOne("colleges_20_sample.xlsx", colleges, collegeHeaders, "Colleges");
writeOne("branches_20_sample.xlsx", branchData, branchHeaders, "Branches");
writeOne("scholarships_20_sample.xlsx", scholarships, scholarshipHeaders, "Scholarships");
writeOne("admission_pathways_20_sample.xlsx", pathways, pathwayHeaders, "Pathways");
...
console.log(`Totals: ${colleges.length} colleges, ${branchData.length} branches, ${scholarships.length} scholarships, ${pathways.length} pathways`);
